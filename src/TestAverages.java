import java.io.*; // Umożliwianie używania klasy IOException
...
public class TestAverages 
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		TestScoreReader scoreReader = new TestScoreReader("/media/mateusz/Seagate 500GB/Projekty/JAVA-kurs/src/Grades.csv");
