...
import java.util.*;             // Umożliwianie używania klas Scanner i InputMismatchException.
...
public class SalesReport2 
{
	...
	/**
	 * Metoda openFile otwiera podany plik
	 * i zwraca referencję do obiektu typu Scanner.
