...
public class SearchArray {
	...
	public static void main(String[] args) {
		...
		{
			System.out.println("Uzyskałeś 100 punktów w teście nr. " + (results + 1) + ".");
		}
	}
	...
	{
		int index; 		// zmiennna sterująca pętli.
		int element; 	// Element, w którym znaleziono szukana wartość.
		boolean found;  // Flaga informująca o wyniku wyszukiwania.
		
		// Element 0 to miejsce rozpoczącie wyszukiwania.
		index = 0;
